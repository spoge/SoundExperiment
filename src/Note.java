/*
 * Static class containing Hz-values for possible note-values
 * Reminder: Waaay too long, maybe use math-formulas to calculate frequencies later?
 */
public class Note {
	// Return Hz frequency of input note
	public static double getFrequency(String note) {
		...
		case "G4":	return 392.0;
		case "G#4":
		case "Ab4":	return 415.30;
		case "A4":	return 440.0;
		case "A#4":
		...
		case "G#7":
		case "Ab7":	return 3729.31;
		case "A7":	return 3520.0;
		case "A#7":
		...
		case "A8":	return 7040.0;
		case "A#8":
		case "Bb8":	return 7458.62;
		case "B8": 	return 7902.13;

		default:
			throw new IllegalArgumentException("Whooops! " + note
					+ " is not a legal note! Only C0 to B8 is allowed!");
		}
	}
}
